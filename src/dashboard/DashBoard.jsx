...
const Dashboard = () => {
    ...
    <div className="container-xxl flex-grow-1 container-p-y">
        <div className="row gy-4">
            ...
            <div className="col-sm-12 col-lg-6">
                <div className="card text-center p-4" style={{ height: '600px', overflowY: 'auto' }}>
                    <Calendar />
                </div>
            </div>
        </div>
        ...
        <div className="row mt-5">
            {/* 왼쪽 - 업무 테이블 */}
            <div className="col-sm-12 col-lg-6">
                <div className="card text-center p-4" style={{ height: '400px', overflowY: 'auto' }}>
                    <TaskTable />
                </div>
            </div>
            ...
            {/* 오른쪽 - 원형 그래프 */}
            <div className="col-sm-12 col-lg-6">
                <div className="card text-center p-4" style={{ height: '400px' }}>
                    <h5>프로젝트 별 원형 그래프</h5>
                    <PieChart />
                </div>
            </div>
